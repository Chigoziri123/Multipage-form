...
return (
  <div className='flex flex-col'>
      ...
      {/* Full Name Section */}
      <div className="text-black font-semibold text-lg max-md:max-w-full max-md:mt-2">
      ...
      {/* Address Section */}
      <div className="text-black text-lg font-semibold mt-2 max-md:max-w-full">
        Contact Address
      </div>
      <div className="items-stretch flex justify-between gap-5 mt-2 max-md:max-w-full max-md:flex-wrap">
       ...
       {/* City/Town Field */}
       {/* <input 
          className="text-black text-lg w-full justify-center items-stretch border mt-2 px-6 h-[32px] rounded-xl border-solid border-green-700 max-md:max-w-full max-md:px-5"
          type="text"
      ...
      <div className="items-stretch flex justify-evenly gap-5 max-md:max-w-full mt-4 max-md:flex-wrap">
  ...
  {/* <div className='w-full mx-2 flex-1'>
    <div className='font-bold h-6 mt-3 text-gray-500 tet-xs leading-8 uppercase'>{" "} Full Name as it appears in your documents</div>
